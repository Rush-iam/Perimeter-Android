    ...
    private companion object {
        val specs = listOf(
            ...
            Option("Diagnostics", "zoom_lod_cache", "Zoom LOD cache", Kind.TOGGLE,
                ...
                defaultChecked = true),
            Option("Optimization", "tilemap_lod_hysteresis", "Tilemap LOD hysteresis (%)", Kind.TEXT,
                "Optimization experiment. Delays discrete LOD transitions by the configured percentage; leave empty for control.",
                valueHint = "8"),
            Option("Optimization", "tilemap_lod_rebuild_budget", "Tilemap LOD rebuild budget", Kind.TEXT,
